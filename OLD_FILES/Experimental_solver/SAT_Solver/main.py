...
# csv output
# workbook_file = str(easy.split('.')[0] + '-' + print_heuristic[which_method] + str(time.time()) + "run={}".format(run) + '_final.xlsx')
workbook_file = "jeroslaw_allsizes_hard.xlsx"
...
interval = 10
counter = 1
for sdk in range(1, len(sudokus)+1)[0:2]:
